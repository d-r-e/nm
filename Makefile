...
SRC=src/main.c src/string.c src/output.c src/mach.c src/libft.c src/segments.c src/arch.c
OBJ=obj/main.o obj/string.o obj/output.o obj/mach.o obj/libft.o obj/segments.o obj/arch.o
INC=include/nm.h
